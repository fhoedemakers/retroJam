...
extern const unsigned char gb_overlay_444[];
extern const unsigned char gb_overlay_555[];
extern char *romName;
...
#endif
#if 0
static void __not_in_flash_func(processaudio)()
{
...
static void processinput(bool fromMenu, DWORD *pdwPad1, DWORD *pdwPad2, DWORD *pdwSystem, bool ignorepushed, char *gamepadType = nullptr)
{
...
static int ProcessAfterFrameIsRendered(bool frommenu)
{
...
static void __not_in_flash_func(process)()
{
